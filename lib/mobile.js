...
var gateway = "http://wappaygw.alipay.com/service/rest.htm";
...
var auth = {
  ...
  get: function (accountInfo, keys) {
    var config = conf.make(accountInfo.partner, 'alipay.wap.trade.create.direct');
    ...
    return {
      ...
      request: function (callback) {
        alipay.request(gateway, config.get(), requestCallback(function (error, text) {
            ...
            if (params.res_data) {
              parser.parseString(params.res_data, function(error, json) {
